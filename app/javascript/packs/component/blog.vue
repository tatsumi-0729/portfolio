      ...
      <div class="card_container">
        ...
        <div class="card card-skin">
          <router-link :to="{ name: 'Reference' }" class="reference">
            ...
            <div class="card_textbox">
              <div class="card_title">My First Post</div>
              <div class="card_content">
                My First Post.
                <br />please see in.
              </div>
              <div class="card_post_day">Jul. 2020</div>
            </div>
          </router-link>
        </div>
        <!-- card2 -->
        <div class="card card-skin">
          <router-link :to="{ name: 'Reference' }" class="reference">
            <div class="card_imgframe"></div>
            <div class="card_textbox">
              <div class="card_title">My Second Post</div>
              <div class="card_content">
                My Second Post.
                <br />please see in.
                <br />xoxo
              ...
              <router-link :to="{ name: 'Reference' }" class="reference"></router-link>
            </div>
          </router-link>
        </div>
        <!-- card3 -->
